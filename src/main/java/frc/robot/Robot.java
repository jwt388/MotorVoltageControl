...
public class Robot extends TimedRobot {
  ...
  public void teleopInit() {
    ...
    // Get selected motor mode
    Command motorCommand = robotContainer.getMotorCommand();
    robotContainer.getMotorSubsystem().setDefaultCommand(motorCommand);

    // schedule the drive command
    if (motorCommand != null) {
      motorCommand.schedule();
    }
  }
